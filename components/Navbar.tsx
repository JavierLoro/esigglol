    ...
    <header className="bg-[#0d1321]/95 backdrop-blur sticky top-0 z-50 border-b border-white/8">
      ...
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-4">
          ...
          {links.map(({ href, label }) => (
            <Link
              ...
              className={clsx(
                ...
                pathname === href || (href === '/equipo' && pathname.startsWith('/equipo'))
        ...
        <div className="ml-auto flex items-center gap-3">
          <Link href="/admin" className="hidden md:block text-xs text-white/25 hover:text-white/50 transition-colors">
            Admin
          </Link>
          {/* Hamburger */}
          <button
      ...
      {/* Mobile menu */}
      {open && (
        <div className="md:hidden bg-[#0d1321] border-t border-white/8">
